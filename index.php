<?php include("common/header.php"); ?>
        ...
        <section id="possibilities">
            <article style="background: url('images/article-image-1.jpg') no-repeat;">
                <div class="overlay">
                    <h4>Partez en famille</h4>
                    <p><small>le meilleur à ceux que vous aimez et partagez des moments fabuleux !</small></p>
                    <a href="#" class="button-2">Plus d'infos</a>
                </div>
            </article>

            <article style="background: url('images/article-image-2.jpg') no-repeat;">
                <div class="overlay">
        ...
        <section id="contacts">
            <div class="wrapper">
                ...
                <form>
                    ...
                    <input type="text" for="name" placeholder="Votre nom"/>
                    <label for="email">Email :</label>
                    <input type="text" for="email" placeholder="Votre email"/>
